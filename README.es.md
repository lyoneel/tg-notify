...
description: Librería y CLI en Go para enviar mensajes y archivos de Telegram mediante la Bot API
---
...
> **Repositorio principal**: https://gitlab.com/lyoneel/tg-notify.
...
[página de releases de GitLab](https://gitlab.com/lyoneel/tg-notify/-/releases)
o la
[página de releases de GitHub](https://github.com/lyoneel/tg-notify/releases).
